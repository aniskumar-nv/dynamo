...
const (
	DynamoGraphDeploymentConditionGroveOnDeleteUpdatePending = "GroveOnDeleteUpdatePending"
)

func (s *GroveSpec) GetUpdateStrategy() GroveUpdateStrategyType {
	if s == nil || s.UpdateStrategy == nil {
		return ""
	}
	return s.UpdateStrategy.Type
}
